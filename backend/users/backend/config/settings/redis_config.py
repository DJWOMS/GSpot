...
REDIS_SHARED_HOST = os.getenv('REDIS_LOCAL_HOST', 'redis')
REDIS_SHARED_PORT = int(os.getenv('REDIS_LOCAL_PORT', 6379))
REDIS_SHARED_PASSWORD = os.getenv('REDIS_LOCAL_PASSWORD', None)
