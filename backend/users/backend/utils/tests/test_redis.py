...
class RedisClientTestCase(TestCase):
    ...
    def test_add_AccessToken(self):
        ...
        result = self.redis_access_client.is_token_exist(token='access:test_access_token_one')
    ...
    def test_add_RefreshToken(self):
        ...
        result = self.redis_refresh_client.is_token_exist(token='refresh:test_refresh_token_one')
        self.assertEqual(bool(result), True)

    def test_refresh_in_access(self):
        result_access = self.redis_access_client.is_token_exist(token='refresh:test_refresh_token_one')
        result_refresh = self.redis_refresh_client.is_token_exist(token='access:test_access_token_one')
    ...
    def test_add_TotpToken(self):
        ...
        result = self.redis_totp_client.is_token_exist(token='totp:test_totp_token_one')
        self.assertEqual(bool(result), True)

    def test_is_token_exist_TotpToken(self):
        result_access = self.redis_access_client.is_token_exist(token='totp:test_totp_token_one')
        result_refresh = self.redis_refresh_client.is_token_exist(token='totp:test_totp_token_one')
    ...
    def test_all_tokens_in_one_db(self):
        self.redis_access_client.add_token(token='access_one')
