    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, upload_to='', verbose_name='Company poster')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permission', models.ManyToManyField(blank=True, related_name='developergroup_set', related_query_name='developergroup', to='developer.developerpermission', verbose_name='permission')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='companyuser_set', to='developer.company', verbose_name='Company')),
                ...
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='companyuser_set', related_query_name='companyuser', to='developer.developergroup', verbose_name='developer_groups')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this developer.', related_name='companyuser_set', related_query_name='companyuser', to='developer.developerpermission', verbose_name='developer permissions')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='developer.company', verbose_name='company contacts')),
