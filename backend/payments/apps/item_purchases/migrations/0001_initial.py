    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_purchase_id', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.PROTECT, related_name='item_purchases_history', to='item_purchases.itempurchase')),
            ],
            options={
                'ordering': ['-date_time_creation'],
            },
