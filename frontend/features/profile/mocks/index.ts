...
import { PurchaseCardInterface, CheckoutGameCardInterface, FavoriteGameCardInterface } from '../types'
...
export const generateMockFavoriteGameCard = (props = {}): FavoriteGameCardInterface => ({
  id: faker.datatype.number(),
