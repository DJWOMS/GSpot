...
const SignDelimiter = styled.span`
    font-size: 13px;
    color: #dbdada;
    line-height: 100%;
`

const SignSocial = styled.div`
    display: flex;
    flex-direction: row;
...
const SignGroupCheckbox = styled.div`
    position: relative;
    margin-bottom: 20px;
    width: 100%;
    width: 100%;
                ...
                <div className="container">
                    <SignContent>
                        <SignForm>
                            ...
                            <SignDelimiter>or</SignDelimiter>
                            <SignSocial>
                                <SignSocialA href="#">
